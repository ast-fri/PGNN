...
# # # Arguments for SGC sketch experiment
DATASET="citeseer"
ARCH="SGC"
LEARN_RATE=0.01           # sys.argv[3]
L2_PARAM=1e-4            # sys.argv[4]
RATIO=0.018              # sys.argv[5]
...
# DATASET="citeseer"
# ARCH="GCN"
# LEARN_RATE=0.008           # sys.argv[3]
# L2_PARAM=2e-3            # sys.argv[4]
# RATIO=0.018              # sys.argv[5]
# USE_RANK_APPROX="False"   # sys.argv[6]
...
# DATASET="citeseer"
# ARCH="GAT"
# LEARN_RATE=0.001           # sys.argv[3]
# L2_PARAM=0.0001            # sys.argv[4]
# RATIO=0.018                # sys.argv[5]
# USE_RANK_APPROX="False"   # sys.argv[6]
# NUM_LAYERS=2              # sys.argv[7]
# HIDDEN_DIM=128            # sys.argv[8]
